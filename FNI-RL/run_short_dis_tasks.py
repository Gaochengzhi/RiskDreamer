...
parser.add_argument(
    "--env_name", default="TrafficEnv1-v0", help="name of the environment to run"
)
parser.add_argument("--seed", default=0)
parser.add_argument("--train_step", default=300000)
...
def train():
    ...
    for n_epi in range(args.train_step):
        score, v, v_epi, xa, ya, done = alg.interaction(
            args.T_horizon, score, v, v_epi, args.speed_range, args.max_a, n_epi
        )

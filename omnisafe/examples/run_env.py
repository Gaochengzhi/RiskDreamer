...
class Highway_env(gym.Env):
    ...
    def close(self):
        print("xxxxxxxxxxxxx Closing! xxxxxxxxxxx")
    ...
    def step(self, action):
        try:
            ...
            reward -= 0.001 * self._compute_soomth_loss(action, reward)
